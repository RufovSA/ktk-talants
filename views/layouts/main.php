                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                            ...
                            <div class="dropdown-menu" id="dropdown-menu3" aria-labelledby="navbarDropdown3">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="row">
                                                <div class="rs-icon-menu col-3">
                                                    <img src="/images/courses/bp.png" alt="Большая Перемена"/>
                                                </div>
                                                <div class="col-9"><a class="dropdown-item" href="/contests/bp">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                ...
                                                <div class="col-9"><a class="dropdown-item"
                                                                                   href="/contests/xod">
                    ...
                    <div class="form-inline" style="width: 350px">
                        ...
                        <?php else: ?>
                            ...
                            <a href="#" data-toggle="modal" data-target="#modal_lk">
                                <div class="ava"<?php if (Yii::$app->user->identity->photo): ?> style="background-image: url('/uploads/<?= Yii::$app->user->identity->photo ?>');"<?php endif ?>></div>
...
<?php if (!Yii::$app->user->isGuest): ?>
<div id="modal_lk" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div style="padding: 1em">
                                <h3 class="text-center">Добро пожаловать, <?= Yii::$app->user->identity->fio ?>!</h3>
                                <hr />
                                <div class="text-center mb-2"><a href="/lk"><button class="btn btn-primary w_100">Личный кабинет</button></a></div>
                                <div class="text-center mb-2"><a href="/lk/edit"><button class="btn btn-primary w_100">Редактировать профиль</button></a></div>
                                <hr />
                                <?php if (Yii::$app->user->identity->role == '1'): ?>
                                    <div class="text-center mb-2"><a href="/admin"><button class="btn btn-primary w_100">Панель администратора</button></a></div>
                                    <hr />
                                <?php endif ?>
                                <div class="text-center mb-2"><a href="/logout"><button class="btn btn-primary w_100">Выход</button></a></div>
                            </div>
                        </div>
                    </div>
                </div>
